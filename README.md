# ZYBO UART
Testing my UART driver on the pmodUSBUART. Really simple test just to validate my logic, and zybo doesnt have loads of switches, or seven seg decoder, to do custom data. Will eventually add a RAM I think to rattle off loads of data in chunks for a more interesting test. 
